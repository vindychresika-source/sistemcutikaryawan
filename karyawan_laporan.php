...
if ($cetak) {
    ...
    <head>
        ...
        <style>
            ...
            .employee-info { margin-bottom: 20px; font-size: 11pt; }
    ...
    <body>
        ...
        <div class="title">
            <h2>Laporan Rekapitulasi Pengajuan Cuti Mandiri</h2>
        ...
        <div class="employee-info">
            <table>
                <tr style="border:none;"><td style="border:none; width:120px; padding:2px;">Nama Karyawan</td><td style="border:none; width:10px; padding:2px;">:</td><td style="border:none; padding:2px; font-weight:bold;"><?= htmlspecialchars($user_nama) ?></td></tr>
                <tr style="border:none;"><td style="border:none; padding:2px;">Jabatan</td><td style="border:none; padding:2px;">:</td><td style="border:none; padding:2px;"><?= htmlspecialchars($_SESSION['user']['jabatan']) ?></td></tr>
                <tr style="border:none;"><td style="border:none; padding:2px;">Email Kantor</td><td style="border:none; padding:2px;">:</td><td style="border:none; padding:2px;"><?= htmlspecialchars($_SESSION['user']['email']) ?></td></tr>
            </table>
        </div>
        ...
        <table>
            ...
            <tbody>
                <?php if(empty($laporan)): ?>
                    <tr><td colspan="6" class="text-center">Tidak ada data laporan yang sesuai filter.</td></tr>
                <?php else: 
                    $no = 1;
                    foreach($laporan as $l): ?>
                    <tr>
        ...
        <div class="footer-sign">
            <div class="sign-box">
                ...
                <p>Karyawan Pengaju</p>
                <div class="sign-space"></div>
                <p style="text-decoration: underline; font-weight: bold;"><?= htmlspecialchars($user_nama) ?></p>
                <p><?= htmlspecialchars($_SESSION['user']['jabatan']) ?></p>
            </div>
        </div>
...
// Meta layout
$page_title = 'Laporan Cuti Pribadi';
$active_menu = 'laporan';
...
<div class="container-fluid p-0">
    <!-- Header Halaman -->
    <div class="mb-4">
        <h3 class="m-0 fw-bold text-main">Laporan Cuti Pribadi</h3>
        <p class="text-muted small m-0">Menyaring rekapitulasi data cuti Anda sendiri dan mencetak laporan dalam format fisik/PDF.</p>
    </div>
    ...
    <div class="card custom-card">
        <div class="card-body-custom">
            <form method="GET" action="" class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label">Dari Tanggal Pengajuan</label>
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="karyawan_laporan.php?tgl_awal=<?= urlencode($tgl_awal) ?>&tgl_akhir=<?= urlencode($tgl_akhir) ?>&jenis_cuti=<?= urlencode($jenis_cuti) ?>&cetak=true" target="_blank" class="btn btn-cancel w-50 py-2" style="border-color: var(--primary-purple); color: var(--dark-purple);">
            ...
            <div class="table-responsive">
                <table class="table custom-table align-middle">
                    ...
                    <tbody>
                        <?php if (empty($laporan)): ?>
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">Belum ada data pengajuan dalam laporan. Silakan atur filter pencarian.</td>
                            </tr>
                        <?php else: 
                            $no = 1;
                            foreach ($laporan as $l): 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <small class="text-muted" style="font-size: 0.75rem;">Diajukan: <?= date('d/m/Y', strtotime($l['tanggal_pengajuan'])) ?></small>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="text-truncate" style="max-width: 250px;" title="<?= htmlspecialchars($l['alasan']) ?>">
